/**
 * Character sub-components barrel export.
 *
 * Shared building blocks used by CharacterSidebar (sidebar) and CharacterPage (full page).
 */
...
export { EquipmentPaperdoll } from './EquipmentPaperdoll';
...
export { ConsumablesBelt } from './ConsumablesBelt';
